                ...
                <c:if test="${session_login_user.id != session_user.id}">
                    ...
                    <div id="follow_form">
                        ...
                        <c:if test="${ruser_id_a == false}">
                            <form class="new_relationship" action="/posts/relationships/${session_user.id}"
                                  method="post">
                        ...
                        <c:if test="${ruser_id_a == true}">
                            <form class="new_relationship" action="/posts/relationships_f/${session_user.id}"
                                  method="post">
            ...
            <ol class="posts">
                <ul id="pn">
                    ...
                    <c:forEach items="${session_post}" var="p" varStatus="status">
                        <form action="/users/comments" method="post">
                            <li class="list0">
                                <div class="head">
                                ...
                                <div class="content">
                                    ...
                                    <div class="comment-list">
                                        ...
                                        <div class="hf">
                                            ...
                                            <input name="commId" type="button" value="${c.id}">
